...
using Figure = FiguresLib.GeometricFigure;
using Point = FiguresLib.Point;
using Line = FiguresLib.Line;
using Ellipse = FiguresLib.Ellipse;
using Rectangle = FiguresLib.Polygon;
...
public partial class MainWindow : Window
{
    ...
    private void BrowseButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        if(openFileDialog.ShowDialog() == true)
        {
            ...
            Type abstractClassType = assembly.GetType("FiguresLib.GeometricFigure");
